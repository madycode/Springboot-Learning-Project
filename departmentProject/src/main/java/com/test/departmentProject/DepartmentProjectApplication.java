package com.test.departmentProject;
...
import com.test.departmentProject.api.security.repository.UserRepository;
...
public class DepartmentProjectApplication {
	...
	public static void main(String[] args) {
		...
		System.out.println("==============1============================================");
	     //  ApplicationContext applicationContext = SpringApplication.run(DepartmentProjectApplication.class, args);
